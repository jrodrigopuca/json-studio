...
const departments = ["Engineering", "Design", "Product", "Marketing", "Sales", "HR", "Finance", "Legal", "Support", "DevOps"];
const roles = ["Senior Engineer", "Staff Engineer", "Junior Engineer", "Designer", "Product Manager", "Analyst", "Director", "VP", "Lead", "Intern"];
const skillSets = [
...
const firstNames = ["Alice","Bob","Carol","David","Eva","Frank","Grace","Henry","Iris","Jack","Kate","Liam","Mia","Noah","Olivia","Paul","Quinn","Ryan","Sara","Tom","Uma","Vic","Wendy","Xander","Yara","Zane"];
const lastNames = ["Johnson","Smith","Williams","Brown","Martinez","Davis","Garcia","Wilson","Anderson","Taylor","Thomas","Moore","Jackson","Martin","Lee","Harris","Clark","Lewis","Walker","Hall","Young","King","Wright","Lopez","Hill","Scott","Green","Adams","Baker","Nelson"];
const cities = ["San Francisco","New York","Seattle","Austin","Denver","Chicago","Boston","Portland","Miami","Atlanta"];
const states = ["CA","NY","WA","TX","CO","IL","MA","OR","FL","GA"];
const streets = ["Main St","Oak Ave","Pine Rd","Elm Blvd","Cedar Ln"];
const projectNames = ["CloudSync","DataVault","Analytics","DevPortal","MobileApp","APIGateway","MLPipeline","Dashboard"];
const projectSuffix = ["v2","Rewrite","Migration","Upgrade","Integration"];
const projectStatus = ["active","completed","on-hold","planning"];
const categories = ["SaaS","Security","Business Intelligence","DevTools","Infrastructure","AI/ML","Communication","Analytics","Automation","Monitoring"];
const productNames = ["CloudSync","DataVault","Analytics","DevPortal","MobileKit","APIGateway","MLEngine","DashView","AutoDeploy","MonitorPro"];
const productTiers = ["Pro","Enterprise","Starter","Team","Ultimate"];
const allFeatures = ["Real-time sync","Offline mode","Team collaboration","SSO","Audit logs","API access","Custom reports","Data export","Webhooks","Role-based access"];
const capabilites = ["analytics","security","automation","monitoring","collaboration"];
...
const monthlyMetrics = Array.from({ length: 24 }, (_, i) => {
  ...
  return {
    ...
    regions: {
      ...
      europe: +(0.30 + Math.cos(i) * 0.03).toFixed(3),
      asia: +(0.15 + Math.sin(i * 0.7) * 0.02).toFixed(3),
      other: +(0.10).toFixed(3),
    },
  };
});
